...
@section('content')
   ...
   @include('admin.topnav')
    ...
    <div class="row">
        <div class="col-md-8">
        <h2 class="mb-0" style="color:#fff;">Editing {{ $collection->name }}</h2>
...
@endif     
 ...
 <form role="form" action="/collection/edit" method="post">
        {{ csrf_field() }}
...
<div class="custom-control custom-checkbox">
  <input type="checkbox"  value="{{ $c->id }}" class="custom-control-input" id="customCheck{{ $c->id }}" name="categories[]" {{ in_array($c->id, $selectedCategories) == true ? "checked" : "" }}>
