...
<h2 class="mb-0">Translator Applications</h2>
                ...
                <tr>
                   ...
                   <td class="text-right">
                      <div class="dropdown">
                        ...
                        <a class="dropdown-item" href="/applications/delete/{{ $l->id }}">Delete</a>
                            ...
                            <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <p><b>Education: </b> {{ $l->education }}  
                                                <br />
                                                <b>Langauges: </b> {{ $l->language_pair }} <br />
                                                <b>Field of Expertise: </b> {{ $l->field_of_expertise }}
                                    </p>
