...
<body>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-flex flex-column text-center">
                            <form>
                                ...
                                <br><br>
                                <button type="button" class="btn btn-dark btn-block btn-round btn-style">Login</button>
                            </form>
                        ...
                        <div class="tab-content ">
                            ...
                            <div id="login" class=" tab-pane active">
                                ...
                                <form>
                                    ...
                                    <br>
                                    <div>
                                        <button type="CreateAcc_submit" class="btn btn-primary btn2">Register</button>
                                    </div>
    ...
    <div class="container" type="section_container">
        ...
        <div id="showSuccessAlert" class="alert showSuccessAlert" style="background: #3498db;margin-top:15px;">
            <p style="color:#fff;"> Your case has been succesfully added. </p>
        </div>

        <form class="postCase" method="post">
            @csrf
